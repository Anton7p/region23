...
import {calcMobileSize, calcTabletSize, getDiffRelationConstant} from "./useAdaptiveCSSProp.utils";

export type AdaptiveSize = [number, number, number];

export const useAdaptiveFont = (desktopSize = 17, tabletSize?: number, mobileSize?: number) => {
